...
\begin{document}
    ...
    Variations of this approach have previously been explored by resarchers, making the case for its inclusion in governmental decision-making. For example, \Citeauthor{library_funding} (\citedate{library_funding}) uses linear programming to allocate funding to different college libraries, and \Citeauthor{school_funding} (\citedate{school_funding}) used a mixed-integer model to select schools for funding. 
